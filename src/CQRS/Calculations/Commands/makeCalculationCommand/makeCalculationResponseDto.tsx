...
const MakeCalculationResponseDtoSchema = z.object({
...
type MakeCalculationResponseDto = z.infer<
  typeof MakeCalculationResponseDtoSchema
>;
...
export {
  ...
  MakeCalculationResponseDtoSchema,
